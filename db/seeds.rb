...
comment4 = Comment.create(text: 'Comment4 Class aptent taciti sociosqu adeptos himenaeos. Pellentesque nunc dolor,',
                          user: first_user, post: post3)
comment5 = Comment.create(
  text: 'Comment5  Sed suscipit sodales libero vel mollis. Aenean euismod lm dapibus odio nec sapien rhoncus, ve', user: second_user, post: post1
)
